...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            ExoPlayerTheme {
                val videoModel = hiltViewModel<MainViewModel>()
                ...
                DisposableEffect(lifecycleOwner) {
                    ...
                    onDispose {
                        ...
                        videoModel.player.seekToDefaultPosition()
                        videoModel.player.clearMediaItems()
                    }
                }
                        ...
                        factory = { context ->
                            PlayerView(context).also {
                                ...
                                it.setFullscreenButtonClickListener { isFullScreen ->
                                    if (isFullScreen){
                                        enterFullScreen(playerView = it , context = context , player = videoModel.player)
                                    }else {
                                        exitFullScreen(playerView = it , context = context , player = videoModel.player)
                                    }
                                }
                            }
                        },
